...
(async () => {
  ...
  // Click the 3rd lesson (Feed-Forward)
  ...
  // Save screenshot
  await page.screenshot({ path: '/tmp/screenshot_gpt2_steps.png' });
  console.log("Screenshot saved to /tmp/screenshot_gpt2_steps.png");
