...
if __name__ == '__main__':
    ...
    # 5. Run Mixtral Benchmark
    from model_mixtral.step2_gpt import GPTLanguageModel as Mixtral
    mixtral_results = run_benchmark(Mixtral, "mixtral", test_data)
